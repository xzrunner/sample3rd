...
function man.init()
	...
	-- man.jumpSound = moon.audio.newSource("assets/ManJump.wav" , "static")
	-- man.spraySound = moon.audio.newSource("assets/Shoot.wav" , "static")
...
function man.setNext()
	...
	if man.action == SPR then
		...
		-- moon.audio.play(man.spraySound)
