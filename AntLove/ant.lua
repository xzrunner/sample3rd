...
function ant.init()
	...
	-- ant.jumpSound = moon.audio.newSource("assets/Jump.wav" , "static")
	-- ant.hurtSound = moon.audio.newSource("assets/Hurt.wav" , "static")
...
function ant.move1()
	...
	if moon.keyboard.isDown("right") then
		ant.goRight()
	end

	if moon.keyboard.isDown("left") then
		ant.goLeft()
	end
...
--
function ant.jump()
	if moon.keyboard.isDown("space") == false then
		ant.fallTest()
		return
	end
