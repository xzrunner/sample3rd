...
function newobject:draw()
	...
	local stencilfunc = function() moon.graphics.rectangle("fill", self.parent.x, self.parent.y, self.width, self.height) end
	
	if self.parent.hbar then
		stencilfunc = function() moon.graphics.rectangle("fill", self.parent.x, self.parent.y, self.width, self.parent.height - 16) end
	end
