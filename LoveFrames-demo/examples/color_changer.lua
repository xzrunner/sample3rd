...
function example.func()
	...
	frame:CenterWithinArea(table.unpack(demo.centerarea))
	...
	colorbox.Draw = function(object)
		...
		moon.graphics.rectangle("fill", object:GetX(), object:GetY(), object:GetWidth(), object:GetHeight())
		moon.graphics.set_color(143, 143, 143, 255)
		moon.graphics.setLineWidth(1)
		moon.graphics.setLineStyle("smooth")
		moon.graphics.rectangle("line", object:GetX(), object:GetY(), object:GetWidth(), object:GetHeight())
	end
